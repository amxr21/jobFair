...
const ConfirmAttendance = () => {
    ...
    // If user is logged in, show modal as overlay on their current context
    if (user) {
        return (
    ...
    // If not logged in, show with the auth page background (same as login/signup)
    return (
        <div className="fixed inset-0 flex w-screen h-screen overflow-hidden z-50">
            ...
            <div className="relative flex items-center justify-center w-full h-full p-4">
                {/* Logos at bottom left - hidden on mobile */}
