...
export default class ErrorBoundary extends Component {
    ...
    render() {
        if (this.state.hasError) {
            ...
            return (
                // Full-viewport overlay: a blurred, semi-transparent backdrop
                // covers the WHOLE page (navbar included) rather than sitting
                // inside the content column beside the nav. `fixed inset-0`
                // escapes the flex layout; the high z-index sits above nav/FABs;
                // the card animates in with the app's existing fadeIn/scaleIn.
                <div className="fixed inset-0 z-[100000] flex items-center justify-center p-4 bg-white/50 backdrop-blur-md animate-fadeIn">
                    <div className="w-full max-w-md bg-white rounded-2xl border border-gray-100 shadow-2xl p-6 md:p-8 text-center flex flex-col items-center gap-4 animate-scaleIn">
