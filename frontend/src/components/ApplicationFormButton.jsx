const ApplicationFormButton = () => {
    return (
        <a href="https://jobfairform-frontend.onrender.com/" target="_blank" className="bg-[#0E7F41] flex justify-between p-3 rounded-xl w-full text-white font-medium uppercase">
            Application Form
