...
const TopBar = ({user}) => {
    ...
    return (
        <div id="TopBar" className="w-full min-h-24 border border-[0.5px] flex items-center justify-between p-5 rounded-2xl">
            <div className="user flex gap-x-4">
                ...
                <div className="name">
                    <h2 className="text-2xl font-bold">{user ? user.email.split('@')[0] == 'casto' ? "CASTO Office" : user?.companyName : "Visitor"}</h2>
