...
const ConfirmMessageDiv = ({confirmMessageRef, qrCodeSrc}) => {
    return (
        <div ref={confirmMessageRef} className="opacity-0 flex flex-row gap-x-16 items-center justify-center bg-white rounded-2xl shadow-2xl px-16 py-12 my-4 h-0 overflow-hidden">
