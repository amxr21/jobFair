const TableHeader = ({userType}) => {
    ...
    ?
        <>
            <div className="row grid py-4 pl-7 pr-20 rounded-xl font-bold text-xs md:text-[0.8rem] 2xl:text-base">
    ...
    :
    <>
            <div className="row-manager grid py-4 pl-7 pr-20 rounded-xl font-bold text-xs md:text-[0.8rem] 2xl:text-base">
                <h2 className="flex items-center break-words whitespace-normal overflow-hidden text-ellipsis max-w-full">#</h2>
