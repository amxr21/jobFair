        ...
        <div className="login-window relative w-full md:w-[48rem] flex flex-col items-center gap-y-10 md:gap-y-20 bg-white rounded-3xl px-8 md:px-16 py-4 md:py-12 md:box-border max-h-full flex md:overflow-y-hidden">
            ...
            <div className="flex flex-col items-center gap-y-4 md:gap-y-9 w-full">
                ...
                <form onSubmit={handleSubmit} className="w-full flex flex-col items-center">
                    ...
                    />
                    <div className="relative w-10/12 flex items-center relative border rounded-xl mb-2">
                        <input
                        ...
                        />
                        <button onClick={handleShowingPass} className="absolute flex items-center justify-center right-1.5 inset-y-1 w-10">
                            {
                                isVisible 
                                ?
                                <svg className="opacity-30 size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
